...
const TABS = [
  { mode: "all", to: "/vendor/quality/all", label: "All" },
  { mode: "pending", to: "/vendor/quality/pending", label: "Pending" },
  { mode: "inspection", to: "/vendor/quality/inspection", label: "Inspection & Grading" },
  { mode: "completed", to: "/vendor/quality/completed", label: "Completed" },
];
...
export default function ManagerQualityListPage({ mode = "pending" }) {
  ...
  const openRow = (row) => navigate(`/vendor/quality/${row.orderId}`);
  ...
  return (
    <div className="space-y-4 sm:space-y-5 p-4 sm:p-6 lg:p-8">
      <div>
