    ...
    <div className="mx-auto max-w-4xl space-y-4 p-4 sm:p-6 lg:p-8">
      ...
      {canReceive ? (
        <section className={EXCEL_PANEL}>
          ...
          <div className="space-y-2 p-3">
            ...
            <Link to={`/vendor/pickups/${pickupId}/receive`} className={EXCEL_BTN_PRIMARY}>
      ...
      <section className={EXCEL_PANEL}>
        ...
        <div className="space-y-2 p-3 text-xs text-[#6B7280]">
          ...
          <p>After the driver reaches the collection centre, you receive the order there.</p>
          ...
          <Link to="/vendor/pickups/ready" className={EXCEL_BTN}>Back</Link>
        </div>
      </section>
