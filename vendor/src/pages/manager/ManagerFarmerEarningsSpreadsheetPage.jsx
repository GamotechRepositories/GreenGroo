...
export default function ManagerFarmerEarningsSpreadsheetPage() {
  ...
  if (!farmer) {
    return (
      <div className={`${EXCEL_PANEL} p-8 text-center text-xs text-[#DC2626] space-y-3`}>
        ...
        <Link to="/vendor/earnings" className={`${EXCEL_BTN_PRIMARY} inline-block px-3 py-1.5`}>
  ...
  return (
    <div className="space-y-4 p-4 font-sans text-xs sm:p-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <Link
            to={`/vendor/all-farmers/${farmer.id}`}
