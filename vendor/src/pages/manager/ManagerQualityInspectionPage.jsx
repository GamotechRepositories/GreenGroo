...
export default function ManagerQualityInspectionPage() {
  ...
  if (!data && !error) return <p className="p-4 sm:p-6 lg:p-8 text-xs text-[#6B7280]">Loading quality inspection…</p>;
  ...
  return (
    <div className="space-y-5 p-4 sm:p-6 lg:p-8">
      <p className="mb-1 break-words text-xs text-[#6B7280] print:hidden">
        <Link to="/vendor/quality/pending" className="hover:text-[#217346]">Quality and Grading Manager</Link>
