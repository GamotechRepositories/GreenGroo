  ...
  return (
    <div className="space-y-4 p-4 sm:space-y-5 sm:p-6 lg:p-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="rounded-xl border border-gray-200 bg-white px-4 py-2.5 shadow-sm min-w-[180px]">
          <span className="text-[11px] font-normal uppercase tracking-wider text-gray-500">Total Registered Crops</span>
          <p className="mt-0.5 text-xl font-bold text-gray-900">{stats.total}</p>
        </div>

        <div className="w-full sm:max-w-md">
          <div className="flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-3 py-2.5 shadow-sm focus-within:border-[#217346]">
            <input
              type="search"
              value={search}
      ...
      {crops.length === 0 ? (
        ...
        <div className={`${PANEL} p-8 text-center`}>
          ...
          <p className="text-xs text-gray-500 mt-1">Try adjusting your search options.</p>
        </div>
      ) : (
