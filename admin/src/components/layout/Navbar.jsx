...
import { Moon, Sun, Menu, ShieldCheck } from 'lucide-react';
    ...
    <header className="sticky top-0 z-30 flex h-16 w-full items-center justify-between border-b border-slate-200/80 bg-white/80 px-4 sm:px-6 backdrop-blur-md dark:bg-[#0b1310]/80 dark:border-slate-800/80 transition-all duration-300">
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          className="rounded-xl border border-slate-200 p-2 text-slate-500 hover:bg-slate-100 hover:text-slate-700 dark:border-slate-800 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200 transition-colors"
        >
