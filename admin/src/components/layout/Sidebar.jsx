...
import { Leaf, LogOut, ChevronLeft, ChevronRight, ShieldCheck } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="flex h-16 items-center justify-between px-4 border-b border-slate-100 dark:border-slate-800/70">
        <NavLink to="/" className="flex items-center gap-3 overflow-hidden" onClick={handleNavClick}>
      ...
      <div className="flex-1 overflow-y-auto px-3 py-4 custom-scrollbar space-y-5">
