...
export function Ready2CookCategoryCard({ cat, onClick, isSelected }) {
  return (
    <div
      onClick={onClick}
      className={`group relative overflow-hidden rounded-[22px] p-3 sm:p-4 min-h-[96px] sm:min-h-[118px] cursor-pointer transition-all duration-200 hover:scale-[1.02] hover:shadow-md border ${
        isSelected ? "border-orange-600 ring-2 ring-orange-500/30" : "border-slate-200/60"
      } ${cat.bgClass || "bg-[#FFF8E7]"}`}
    >
...
export default Ready2CookCategoryCard;
