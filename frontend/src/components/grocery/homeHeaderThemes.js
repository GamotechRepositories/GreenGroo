...
export const STORE_THEMES = {
  main: {
    ...
    activeTabBorder: "border-emerald-300/60",
    inactiveTabClass: "bg-white text-slate-900 shadow-sm border border-slate-200/90",
  ...
  festive: {
    ...
    activeTabBorder: "border-orange-300/60",
    inactiveTabClass: "bg-white text-slate-900 shadow-sm border border-slate-200/90",
    searchBorder: "border-transparent",
    placeholder: 'Search for "Ready2Cook"',
    categoryBorder: "border-orange-900/10",
