...
export const STORE_THEMES = {
  ...
  mall: {
    key: "mall",
    time: "15 minutes",
    deliveryBg: "bg-gradient-to-b from-[#0F172A] via-[#1E1B4B] to-[#312E81]",
    searchBg: "bg-gradient-to-b from-[#312E81] via-[#3730A3] to-[#4338CA]",
    categoryBg: "bg-gradient-to-b from-[#4338CA] via-[#6366F1] to-[#818CF8]",
    bannerBg: "bg-white",
    contentBg: "bg-white",
    textColor: "text-white",
    subTextColor: "text-slate-200",
    profileClass: "bg-black border border-white/40 text-white",
    activeTabBg: "bg-[#312E81]",
    activeTabBorder: "border-violet-400/40",
    inactiveTabClass: "bg-white text-slate-900 shadow-sm border border-transparent",
    searchBorder: "border-transparent",
    placeholder: 'Search for "Super Mall"',
    categoryBorder: "border-white/20",
    categoryText: "text-white",
    categoryInactive: "text-white/80",
