  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2 text-xs text-[#6B7280]">
        <Link to="/manager/farmers" className="hover:text-[#217346]">Farmers</Link>
        <span>›</span>
        ...
        {tab === "Crops" && (
          <div>
            <div className="flex items-center justify-between gap-2 border-b border-[#D4D4D4] px-3 py-2.5">
              ...
              <Link
                to={`/manager/farmers/${farmerId}/crops/add`}
                  ...
                  <tr key={crop.cropId || crop.id} className="border-b border-[#D4D4D4] last:border-0 hover:bg-[#F9F9F9]">
                    ...
                    <td className="px-3 py-2.5">
                      <div className="flex flex-nowrap items-center gap-1.5">
                        <Link
                          to={`/manager/farmers/${farmerId}/crops/${encodeURIComponent(crop.cropId || crop.id)}`}
                          className="border border-[#D4D4D4] bg-white px-2.5 py-1 text-[11px] font-semibold hover:bg-[#F2F2F2]"
                        >
                          View
                        </Link>
                        <Link
                          to={`/manager/farmers/${farmerId}/crops/${encodeURIComponent(crop.cropId || crop.id)}/edit`}
                          className="border border-[#D4D4D4] bg-white px-2.5 py-1 text-[11px] font-semibold hover:bg-[#F2F2F2]"
                        >
                          Edit
                        </Link>
        ...
        {tab === "Products" && (
          <div>
            <div className="flex items-center justify-between gap-2 border-b border-[#D4D4D4] px-3 py-2.5">
              ...
              <Link
                to={`/manager/farmers/${farmerId}/products/add`}
                className={`${EXCEL_BTN_PRIMARY} px-3 py-1.5 text-[11px]`}
              >
                + Add Product
              </Link>
        ...
        {tab === "Earnings" && (
          <div className="p-3 space-y-3">
            <div className="flex justify-between items-center bg-[#F2F8F3] p-2.5 border border-[#D4D4D4]">
              ...
              <Link
                to={`/manager/earnings/farmer/${farmer.id}`}
