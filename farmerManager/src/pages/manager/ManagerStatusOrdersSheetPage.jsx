...
function productSheetPath(order) {
  ...
  return `/manager/orders/product/${encodeURIComponent(key)}?${params.toString()}`;
}
  ...
  return (
    <div className="min-w-0 space-y-3">
      <div className="flex flex-wrap items-start justify-between gap-2">
        <div>
          <Link to="/manager/orders" className={`${EXCEL_BTN} mb-1 inline-flex text-[11px]`}>
            ← All Orders
          </Link>
              ...
              return (
                <div key={id} className="px-3 py-2.5">
                  ...
                  <div className="mt-2 grid grid-cols-2 gap-1.5">
                    ...
                    {order.farmerId ? (
                      <Link
                        to={`/manager/orders/farmer/${order.farmerId}`}
