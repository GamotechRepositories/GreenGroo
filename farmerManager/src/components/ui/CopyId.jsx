...
export function CopyButton({ value, label = "Copy ID", className = "" }) {
  ...
  return (
    <button
      ...
      className={`inline-flex h-4 w-4 sm:h-5 sm:w-5 shrink-0 items-center justify-center rounded text-[#6B7280] hover:bg-slate-100 hover:text-[#217346] transition-colors ${className}`}
    >
      {copied ? <CheckIcon className="h-3 w-3 sm:h-3.5 sm:w-3.5 text-[#217346]" /> : <CopyIcon className="h-3 w-3 sm:h-3.5 sm:w-3.5" />}
    </button>
  );
}
