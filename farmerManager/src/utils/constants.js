...
export const FARMER_STORAGE_KEY = "greengroo_farmer_manager_auth";
...
export const MANAGER_SIDEBAR_ITEMS = [
  { to: "/manager/dashboard", label: "Dashboard", icon: "dashboard" },
  {
    ...
    icon: "community",
    children: [
      { to: "/manager/farmers", label: "All Farmers" },
      { to: "/manager/farmers/add", label: "Add Farmer" },
    ],
  },
  {
    id: "crops",
  ...
  },
  {
    ...
    icon: "products",
    children: [
      { to: "/manager/products", label: "All Products", end: true },
      { to: "/manager/products/add", label: "Add Product" },
    ],
  },
  {
    id: "inventory",
  ...
  },
  {
    ...
    label: "Pickup",
    icon: "pickup",
    match: "/manager/pickups",
    excludeMatch: [
      "/manager/pickups/ready",
      "/manager/pickups/assigned",
      "/manager/pickups/today",
    ],
    children: [
      { to: "/manager/pickups/incoming", label: "Incoming Pickups" },
      { to: "/manager/pickups/centre", label: "Pickups at Centre" },
      { to: "/manager/pickups/all", label: "All Pickups" },
    ],
  },
  {
    id: "driver",
    label: "Driver",
    icon: "driver",
    match: "/manager/drivers",
    children: [
      { to: "/manager/pickups/ready", label: "Ready for Pickup" },
      { to: "/manager/pickups/assigned", label: "Assigned Pickups" },
      { to: "/manager/pickups/today", label: "Today's Pickups" },
      { to: "/manager/drivers", label: "All Drivers", end: true },
    ],
  },
  {
    id: "quality",
    ...
    icon: "quality",
    children: [
      { to: "/manager/quality/all", label: "All Inspection" },
      { to: "/manager/quality/pending", label: "Pending Inspection" },
      { to: "/manager/quality/inspection", label: "Quality Inspection & Grading" },
      { to: "/manager/quality/completed", label: "Completed" },
    ],
  },
  { to: "/manager/documents", label: "Documents", icon: "documents" },
  { to: "/manager/policies", label: "Policies", icon: "documents" },
